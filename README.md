...
> New v2.3.10 made live on 01-Nov-2018

[![Platform](https://img.shields.io/badge/Platform-Android-green.svg)](#)
[![Source](https://img.shields.io/badge/Source-JitPack-brightgreen.svg)](https://jitpack.io/private#vatsanatech/OneFeed-Android-SDK/2.3.10)
...
1. [Integrate OneFeed with JitPack](https://jitpack.io/private#vatsanatech/OneFeed-Android-SDK/2.3.10)
...
```
* add OneFeed-Android-SDK:2.3.10 in your app level build.gradle
```gradle
    dependencies {
	        implementation 'com.github.vatsanatech:OneFeed-Android-SDK:2.3.10'
	}
```
