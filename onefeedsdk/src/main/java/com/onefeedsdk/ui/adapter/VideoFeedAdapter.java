...
//        //Publisher
                ...
                Palette.from(resource)
                        .generate(new Palette.PaletteAsyncListener() {
                            ...
                            public void onGenerated(@NonNull Palette palette) {
                               ...
                               // Util.changedBackgroundColorToRes(holder.categoryView , textSwatch.getRgb());
                            }
                        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            posterRowLayout = itemView.findViewById(R.id.layout_video_row);
...
//            writerView = itemView.findViewById(R.id.view_writer);
            ...
            publisherImage.setVisibility(View.GONE);
        }
    }
}
