...
class CardViewHolderFactory {
    ...
    synchronized View getInflatedBlockViewHolder(int blockTypeNum){

        if(inflater == null){
            OFLogger.log(OFLogger.ERROR, "Inflater is null, set inflater via method setInflater() first");
            return null;
        }
    ...
    synchronized void setInflater(LayoutInflater inflater) {
