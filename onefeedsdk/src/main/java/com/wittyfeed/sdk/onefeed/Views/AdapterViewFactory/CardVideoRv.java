...
public final class CardVideoRv {

    public void initRv(RecyclerView rv, List<Card> cardList, double textSizeRatio){
    ...
    public class VideoRVAdapter extends RecyclerView.Adapter<MainAdapterBaseViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MainAdapterBaseViewHolder holder, int position) {
            int width = (int) (Utils.getScreenWidth(holder.root_vg.getContext()) * textSizeRatio);
